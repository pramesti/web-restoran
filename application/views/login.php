					...
					<div class="left">
						<div class="content">
							<div class="header">
								...
								<p class="lead">Masukkan Akun Anda</p>
							</div>
							<form class="form-auth-small" method="post" action="<?=base_url('login/prosesLogin')?>">
								...
								<div class="bottom">
									<span class="helper-text"><a href="<?=base_url('register')?>">Register</a></span>
								</div>
							</form>
						</div>
					</div>
